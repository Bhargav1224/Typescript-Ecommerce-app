...
import { authSignUp } from "../../Redux/authentication/authAction";
import { useNavigate } from "react-router-dom";

interface ISignUpInputProps {
  signUpData: SignUpModel;
  setSignUpData: React.Dispatch<React.SetStateAction<SignUpModel>>;
}

const SignUpInput: React.FunctionComponent<ISignUpInputProps> = ({
  signUpData,
  setSignUpData,
}) => {
  ...
  const handleSubmit = (): void => {
    // calling the SignUp API from SignUpPage container by passing the email and password
